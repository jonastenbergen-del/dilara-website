    ...
    return (
        <div className="flex items-center gap-3 sm:gap-4">
            {timeUnits.map((unit, i) => (
                ...
                >
                    <div className="glass rounded-xl px-3 py-2 sm:px-4 sm:py-3 min-w-[60px] sm:min-w-[80px]">
                        <motion.span
                            className="text-2xl sm:text-3xl lg:text-4xl font-bold gradient-text font-display"
                    ...
                    <span className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1">
                        {unit.label}
                    </span>
                </motion.div>
            ))}
            <span className="hidden sm:block text-2xl text-primary-400">+</span>
            <motion.div
                className="flex flex-col items-center"
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
            ...
            >
                <div className="glass rounded-xl px-3 py-2 sm:px-4 sm:py-3 min-w-[50px] sm:min-w-[70px]">
                    <span className="text-xl sm:text-2xl lg:text-3xl font-bold text-magenta-500 font-display">
                        ∞
                    </span>
                </div>
                <span className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1">
...
export default function HeroSection() {
    ...
    return (
        ...
        >
                ...
                <AnimatePresence>
                    {isVisible && (
                        <>
                            ...
                            {/* Welcome typing text */}
                            <motion.h2
                                className="text-xl sm:text-2xl font-light text-neutral-600 dark:text-neutral-400 mb-4"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                            ...
                            >
                                ...
                                <motion.span
                                    className="inline-block mx-4 text-primary-400"
                            ...
                            {/* Subtitle */}
                            <motion.p
                                className="text-lg sm:text-xl md:text-2xl font-light text-neutral-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="w-6 h-10 rounded-full border-2 border-neutral-400 dark:border-neutral-600 relative"
                                    >
                                        <motion.div
                                            className="w-1.5 h-1.5 rounded-full bg-neutral-400 dark:bg-neutral-600 absolute left-1/2 -translate-x-1/2"
                                            animate={{
            ...
            <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-neutral-50 dark:from-[#0A0A1A] to-transparent" />
        </section>
    );
}